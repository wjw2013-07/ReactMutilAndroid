    ...
    renderContent(dataSource){
        return(
            <View style={styles.container}>
                <Text style={styles.text}>1 实现订单状态页</Text>
                <ListView
                    initialListSize={1}
            ...
            <View style={{flexDirection: 'row', height: 75}}>
                ...
                <View>
                    ...
                    <Image source={require('../img/ic_order_status_item_bg.png')}
                           style={{height: 65, marginLeft: 10, width: 60}}>
        ...
        return(
            <View style={{flexDirection: 'row', height: 75}}>
                <View>
                    ...
                    <Image source={require(STATUS_IMGS[data.id])} style={{width: 30, height: 30, marginLeft: 10}}/>
                    <Image source={require('../img/ic_order_shu.png')} style={{height: 30, marginLeft: 25, flex: 1}}/>
                </View>

                <View>
                     <View style={{height: 5}}/>
                     <Image source={require('../img/ic_order_status_item_bg.png')} style={{height: 65, marginLeft: 10, width: 60}}>
                            {this.renderCenterContent(data)}
                     </Image>
                      <View style={{height: 5}}/>
                </View>
        ...
        return(
            <View style={{marginLeft: 15, marginTop: 10}}>
                <View style={{flexDirection: 'row'}}>
                    <Text style={{color: 'black', fontSize: 14, backgroundColor: '#000000'}}>
                        {data.status}
                    </Text>
